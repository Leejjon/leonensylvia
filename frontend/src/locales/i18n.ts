...
export const resources = {
    en: {
        translation: {
            ...
            "EMAIL_DESCRIPTION": "Please provide your e-mail so that we can quickly contact you if things change due to Covid:",
    ...
    nl: {
        translation: {
            ...
            "EMAIL_DESCRIPTION": "Vul hier je e-mail adres in zodat we je op de hoogte kunnen houden (bijvoorbeeld in veranderingen door Covid):",
